...
public class BillingClientConfiguration {
    ...
    @Bean
    public BillingClient billingClient(WebClient.Builder builder, @Value("${spring.billingService.url}") String baseUrl) {
        ...
        return factory.createClient(BillingClient.class);
    }
}
